...
public class Piece {
	/***
	 * a piece needs to be able to rotate edges by a number of rotations,
	 * check if it's a corner piece or has a border edge, get matching edge
	 */
	...
	public Piece(Edge[] edgeList) {		
		// One piece we picked up might need turned to fit hence multiple orientations
		// but since all orientations stem from one piece, consider that piece the parent
