...
public class CallHandler {	
     ...
     */
    List<List<Employee>> employeeLevels; // list containing lists of employees

	/* queues for each call�s rank */
    List<List<Call>> callQueues; // list containing lists of calls

    public CallHandler() {
    	employeeLevels = new ArrayList<List<Employee>>(LEVELS); // list of 3
    	callQueues = new ArrayList<List<Call>>(LEVELS); // list of 3
    ...
    public void dispatchCall(Call call) {
        ...
        if (emp != null) {
        	...
        	call.setHandler(emp);
        	call.reply("Your call is being connected");
        } else {
